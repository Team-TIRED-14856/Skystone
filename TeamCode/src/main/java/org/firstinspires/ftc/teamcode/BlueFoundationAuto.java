...
public class BlueFoundationAuto extends com.qualcomm.robotcore.eventloop.opmode.OpMode {
    ...
    public void loop() {
        ...
        switch(iterationsV1){
            case -1:
                if(!driveForwardSeconds(1.2,.5,startGyro)){
                    reset();
                    iterationsV1++;
                }
                break;
            ...
            case 3:
                ...
                break;
            case 4:
                if(!driveForwardSeconds(1,0.5,startGyro)){
                    reset();
                    iterationsV1++;
                }
                break;
